...
export const getChatRoomList = async (searchDTO) => {
  ...
  const res = await jwtAxios.get(`${host}/list`, { params: searchDTO });
  return res.data;
};
...
export const getChatMessages = async (roomId) => {
  ...
  const res = await jwtAxios.get(`${host}/messages/${roomId}`); 
  return res.data;
};
...
export const updateReadStatus = async (roomId, userId) => {
  ...
  const res = await jwtAxios.put(`${host}/${roomId}/read`, null, {
